...
<head>
    ...
    <title>PIÑATERIA&reg;D'MARZO</title>
      ...
      ?>
      <script src="./js/arreglos1.js"></script>
      <?php
      }
      ?>    
    ...
    <h1><p align="center" style="background-color:lightsalmon">ARREGLOS DE GLOBOS</p></h1>
...
?>    
<center>
    <h2><font style="color:rgb(209, 68, 68)"><b>¡Recibe un DESCUENTO del 20% por comprar más de 4 arreglos!</b></font></h2>
...
<body bgcolor="#FEE9C5">
  ...
  <div class="fila"> <!--vista escritorio-vista tablet-vista movil -->
    ...
    <img src="IMG ARREGLOS/img6.jpeg" >
    <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
    </div>  
    <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->       
    <img src="IMG ARREGLOS/img4.jpeg" >
    <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
    </div>      
    <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->             
    <img src="IMG ARREGLOS/img6.jpeg" >
    ...
    <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        ...
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->       
        <img src="IMG ARREGLOS/img8.jpeg" >
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
        </div>      
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->             
        <img src="IMG ARREGLOS/img9.jpeg" >
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
        </div> 

        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
            <img src="IMG ARREGLOS/img13.jpeg" >
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
        </div>          
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
            <img src="IMG ARREGLOS/img14.jpeg" >
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
        </div>       
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
         <img src="IMG ARREGLOS/img15.jpeg" >
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
        </div> 

    <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->          
    <img src="IMG ARREGLOS/img10.jpeg" >
    <i style="font-size: 35px; position: relative;right:-242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
    </div> 
    <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->   
    <img src="IMG ARREGLOS/img11.jpeg" >
    <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
    </div>  
    <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->             
    <img src="IMG ARREGLOS/img12.jpeg" >
    <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
    </div>              
</div>  
    ...
    <table border="0" align="center">
        <tr>
            <th><h1>&nbsp;<button>1</button>&nbsp;|</h1></th>
            <th><h1>|&nbsp;<button><a href="arreglos2.php">2</a></button>&nbsp;</h1></th>
        </tr>
    </table>
