...
<head>
    ...
    <script src="js_yensu/wow.min.js"></script>
     ...
     <?php
      ...
      ?>
      <script src="./js/frozen1.js"></script>
    <?php
    }
    ?>  
...
<body bgcolor="#FFC3FD" text="#000000">
    <header>
        <h1 class="animate__animated animate__flip"><p align="center" style="background-color:hotpink">KIT "FROZEN"</p></h1>
...
?>
<center>
    <h2><font style="color:rgb(102, 57, 104)"><b>¡Recibe el 15% de DESCUENTO por comprar más de 4 elementos de este Kit!</b></font></h2>
...
<div class="fila"> <!--vista escritorio-vista tablet-vista movil -->             
    ...
    <img class="wow animate__fadeInTopLeft"src="IMG Frozen/Captura 1.jpeg" width="300">
    ...
    <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
    <img class="wow animate__bounceInUp"src="IMG Frozen/Captura 2.jpeg" width="300">
    <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
    <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
    <img class="wow animate__fadeInTopRight"src="IMG Frozen/Captura 3.jpeg" width="300">
    <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
           
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img class="wow animate__fadeInTopLeft" src="IMG Frozen/Captura 4.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->     
        <img class="wow animate__bounceInUp"src="IMG Frozen/Captura 5.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->       
        <img class="wow animate__fadeInTopRight"src="IMG Frozen/Captura 6.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
            
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->       
        <img class="wow animate__fadeInTopLeft" src="IMG Frozen/Captura 7.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>   
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->       
        <img class="wow animate__bounceInUp"src="IMG Frozen/Captura 8.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->       
        <img class="wow animate__fadeInTopRight" src="IMG Frozen/Captura 9.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
                
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->       
        <img class="wow animate__fadeInTopLeft" src="IMG Frozen/Captura 10.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->          
        <img class="wow animate__bounceInUp"src="IMG Frozen/Captura 11.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
       <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->             
        <img class="wow animate__fadeInTopRight" src="IMG Frozen/Captura 12.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
    </div>  
</div><br><br>
