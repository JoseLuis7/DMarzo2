...
<head>
    ...
    <!-- Agregar CSS -->
    <link rel="stylesheet" href="./css_jl/frozen.css">
    ...
    <script src="js_yensu/wow.min.js"></script>
     ...
     <?php
      if ($id_cargo==2) {
      ?>  
      <script src="./js/minnie.js"></script> 
      <?php
      }else{
      ?>
      <script src="./js/minnie1.js"></script>
    <?php
    }
    ?>  
...
<body bgcolor="#FFC3FD" text="#000000">
    <header>
        <h1 class="animate__animated animate__flip"><p align="center" style="background-color:hotpink">KIT "MINIE MOUSE"</p></h1>
...
?>    
<center>
    <h2><font style="color:rgb(102, 57, 104)"><b>Compra más de 10 productos y recibe un BONO EN COMPRAS de S/35.00</b></font></h2>
...
?>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label for=""><font color="rgb(102, 57, 104)"><b>Cantidad de productos: </b></font></label>
    <input type="number" name="" id="num">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button type="button" onclick="calcular(
    document.getElementById('num').value);">Calcular el precio</button><br><br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <font color="rgb(102, 57, 104)"><b>El precio a pagar por los productos es de: S/. <span id="resultado"></span></b></font><br><br><br>
...
<!-- VENTANA EMERGENTE --> 
    ...
    <div class="fila"> <!--vista escritorio-vista tablet-vista movil -->             
        ...
        <img class="wow animate__fadeInTopLeft"src="IMG Mini Mouse/Captura5.jpeg" width="300">
        ...
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img class="wow animate__bounceInUp"src="IMG Mini Mouse/Captura6.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div> 
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->      
        <img class="wow animate__fadeInTopRight"src="IMG Mini Mouse/Captura7.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div> 

             
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img class="wow animate__fadeInTopLeft"src="IMG Mini Mouse/Captura8.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div> 
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->       
        <img class="wow animate__bounceInUp"src="IMG Mini Mouse/Captura9.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>    
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->            
        <img class="wow animate__fadeInTopRight"src="IMG Mini Mouse/Captura10.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>     
        ...
        <div class="col-4 col-m-5 col-s-9"> <!-- 04 columnas -->
        <img class="wow animate__fadeInTopLeft"src="IMG Mini Mouse/Captura11.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>    
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img class="wow animate__bounceInUp"src="IMG Mini Mouse/Captura12.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>       
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img class="wow animate__fadeInTopRight"src="IMG Mini Mouse/Captura13.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>  
           
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->    
        <img class="wow animate__fadeInTopLeft" src="IMG Mini Mouse/Captura14.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>      
        <div class="col-4 col-m-5 col-s-9"> <!-- 04 columnas -->    
        <img class="wow animate__bounceInUp"src="IMG Mini Mouse/Captura15.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>   
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->    
        <img class="wow animate__fadeInTopRight" src="IMG Mini Mouse/Captura16.jpeg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>     
    </div><br><br>   
