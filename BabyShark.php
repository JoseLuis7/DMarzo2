...
<head>
    ...
    <?php
      if ($id_cargo==2) {
      ?>  
      <script src="./js/babyshark.js"></script> 
      <?php
      }else{
      ?>
      <script src="./js/babyshark1.js"></script>
    <?php
    }
    ?>    
...
<body bgcolor="#76FFE6" text="#000000">
    <header>
        <h1 class="animate__animated animate__flip"><p align="center" style="background-color:cornflowerblue">KIT "BABY SHARK"</p></h1>
...
?>   
<center>
    <h2><font style="color:darkblue"><b>Por comprar más de 6 kit's: Obtén 1 más GRATIS</b></font></h2>
        ...
        function presione(){
         ...
         <div class="fila"> <!--vista escritorio-vista tablet-vista movil -->
            ...
            <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__fadeInTopLeft" src="IMG Baby Shark/Captura 1.jpeg" width="300">
                ...
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__bounceInUp" src="IMG Baby Shark/Captura 2.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__fadeInTopRight" src="IMG Baby Shark/Captura 3.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>

  
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__fadeInTopLeft" src="IMG Baby Shark/Captura 4.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
                <div class="col-4 col-m-5 col-s-9"> <!-- 04 columnas -->
                <img class="wow animate__fadeInUp" src="IMG Baby Shark/Captura 5.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__fadeInTopRight" src="IMG Baby Shark/Captura 6.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__fadeInTopLeft" src="IMG Baby Shark/Captura 7.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__bounceInUp" src="IMG Baby Shark/Captura 8.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__fadeInTopRight" src="IMG Baby Shark/Captura 9.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
               <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__fadeInTopLeft" src="IMG Baby Shark/Captura 10.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__bounceInUp" src="IMG Baby Shark/Captura 11.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>
                <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img class="wow animate__fadeInTopRight" class="wow animate__fadeInTopRight" src="IMG Baby Shark/Captura 12.jpeg" width="300">
                <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
                </div>   
            </div><br><br>
