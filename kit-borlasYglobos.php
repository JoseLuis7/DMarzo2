...
<head>
    ...
    <!-- Agregar CSS -->
    <link rel="stylesheet" href="./css_atm/kitbolas.css">
    <!-- Agregar js: externa -->
    <?php
      if ($id_cargo==2) {
      ?>  
      <script src="./js/kitborlas.js"></script> 
      <?php
      }else{
      ?>
      <script src="./js/kitborlas1.js"></script>
    <?php
    }
    ?>  
    ...
    <h1><p align="center" style="background-color:lightsalmon">KIT "BANDERÍN-BORLAS-GLOBOS"</p></h1>
    <!-- POSICION DEL ICONO + -->
    <style>
        table,th,td {
            padding: 40px 10px;
...
?>
<center>
    <h2><font style="color:rgb(209, 68, 68)"><b>¡Recibe un 30% de DESCUENTO por compras de más 10 elementos de este Kit!</b></font></h2>
...
<body bgcolor="#FEE9C5">
      ...
      <div class="fila"> <!--vista escritorio-vista tablet-vista movil -->
        ...
        <img src="img2/borla10.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div>
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/borla2.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div>      
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/borla3.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div>
         
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/borla4.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div>     
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/borla5.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div>  
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/borla6.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div> 
     
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->     
        <img src="img2/borla7.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div>      
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->     
        <img src="img2/borla8.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div>      
        <div class="col-4 col-m-5 col-s-9"> <!-- 04 columnas -->     
        <img src="img2/borla9.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 23.00</h2>
        </div>      
    </div>
