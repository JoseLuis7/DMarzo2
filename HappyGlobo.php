...
<head>
    ...
    <?php
      if ($id_cargo==2) {
      ?>  
      <script src="./js/happyglobo.js"></script> 
      <?php
      }else{
      ?>
      <script src="./js/happyglobo1.js"></script>
    <?php
    }
    ?>  
...
<div class="fila"> <!--vista escritorio-vista tablet-vista movil -->
    ...
    <h1><p align="center" style="background-color:lightsalmon">GLOBOS "HAPPY BIRTHDAY"</p></h1>
    <!-- POSICION DEL ICONO + -->
    <style>
        table,th,td {
            padding: 40px 10px;
...
?> 
<center>
    <h2><font style="color:rgb(209, 68, 68)"><b>¡Por la compra de 10 globos o más RECIBE UN BONO en compras de S/30.00!</b></font></h2>
...
<body bgcolor="#FEE9C5">
     ...
     <div class="fila"> <!--vista escritorio-vista tablet-vista movil -->
        ...
        <img src="img2/happyceleste.jpg" width="300">
        ...
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/happyorgane.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div> 
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/happypink.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>
          
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/happygold.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>  
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/happyred.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
        <img src="img2/happysilver.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>
     
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->     
        <img src="img2/happytri.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div> 
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->     
        <img src="img2/happymulti.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>   
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->     
        <img src="img2/happyblue.jpg" width="300">
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 10.00</h2>
        </div>   
    </div>      
