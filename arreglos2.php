...
<head>
    ...
    <div class="fila"> <!--vista escritorio-vista tablet-vista movil -->
        ...
        <hr align="center"  width="80%"  size="6%" color="BLACK" ><br>  <!-- LINEA --> 
    <style>
        table,th,td {
            padding: 40px 10px;
...
<body bgcolor="#FEE9C5">
    ...
    <div class="fila"> <!--vista escritorio-vista tablet-vista movil -->
        ...
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
            <img src="IMG ARREGLOS/img19.jpeg" >
        ...
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->          
            <img src="IMG ARREGLOS/img20.jpeg" >
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
        </div> 
        <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->          
            <img src="IMG ARREGLOS/img21.jpeg" >
        <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
        </div>       
            ...
            <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->
                <img src="IMG ARREGLOS/img16.jpeg" >
            <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
            </div>   
            <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->          
                <img src="IMG ARREGLOS/img18.jpeg" >
            <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
            </div> 
            <div class="col-4 col-m-5 col-s-9 "> <!-- 04 columnas -->          
                <img src="IMG ARREGLOS/img17.jpeg" >
            <i style="font-size: 35px; position: relative;right: -242px; bottom: 283px;" type="button" onclick="presione();"class="fa-solid fa-circle-plus"></i><br><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/. 30.00</h2>
            </div>          
    </div>  
        ...
        <tr>
            <th><h1>&nbsp;<button><a href="arreglos.php">1</a></button>&nbsp;|</h1></th>
            <th><h1>|&nbsp;<button>2</button>&nbsp;</h1></th>
        </tr>
        </table>
